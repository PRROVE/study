...
- **제10회 AI·SW 융합 해커톤**  
  ...
  - 기술 스택:
    - React, TypeScript, TensorFlow.js, MetaMask, Solidity, SCSS
  - 관련 저장소:
    - [`rPPG-EAR-Blockchain-system`](https://github.com/rPPG-EAR-BlockChain/rPPG-EAR-Blockchain-system)
...
- **2025 SW중심대학 디지털 경진대회 – SW 부문**  
  ...
  - 관련 저장소:
    - [`DEMO.APP`](https://github.com/rPPG-EAR-BlockChain/DEMO.APP)
